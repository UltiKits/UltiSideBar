...
import com.ultikits.plugins.sidebar.i18n.UltiSideBarLanguageCatalogueTest.Catalogue;
 ...
 * ({@link UltiSideBarLanguageCatalogueTest#loadModuleCatalogues()}: the framework's own {@link Language},
...
public final class CatalogueText {
    ...
    public static Map<String, String> entries(String code) {
        try {
            for (Catalogue c : UltiSideBarLanguageCatalogueTest.loadModuleCatalogues()) {
